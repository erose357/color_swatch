...
var getRequests = __webpack_require__(9);
var swatches = __webpack_require__(11);
...
function appendSwatches() {
  ...
  var removePunctuation = text.replace(/[.\r?,']/gi, "");
  var wordArray = removePunctuation.split(' ');
  var swatches = [];
  wordArray.forEach(function (word) {
    if (colors[word]) {
      if (swatches.includes(colors[word]) === false) swatches.push(colors[word]);
    }
  });
...
module.exports = { appendSwatches: appendSwatches };
